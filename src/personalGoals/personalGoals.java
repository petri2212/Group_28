...
public class personalGoals {
	...
	private final int arraypos=6;
	private ObjPosition[] arr;

	public ObjPosition[] personalGoal0() {
		 arr=new ObjPosition[arraypos];
		 ...
		 arr[5]= new ObjPosition(5,2, trophy);
	...
	public ObjPosition[] personalGoal1() {
		 ...
		 arr[5]= new ObjPosition(5,4, frame);
	...
	public ObjPosition[] personalGoal2() {
		 ...
		 arr[5]= new ObjPosition(5,0, book);
	...
	public ObjPosition[] personalGoal5() {
		 ...
		 arr[5]= new ObjPosition(5,0, plant);
	...
	public ObjPosition[] personalGoal6() {
		 ...
		 arr[5]= new ObjPosition(5,2, book);
	...
	public ObjPosition[] personalGoal7() {
		 ...
		 arr[5]= new ObjPosition(5,3, game);
	...
	public ObjPosition[] personalGoal8() {
		 ...
		 arr[5]= new ObjPosition(5,0, frame);
	...
	public ObjPosition[] personalGoal9() {
		 ...
		 arr[5]= new ObjPosition(5,3, trophy);
	...
	public ObjPosition[] personalGoal10() {
		 ...
		 arr[5]= new ObjPosition(5,3, plant);
