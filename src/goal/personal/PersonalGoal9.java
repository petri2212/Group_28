...
public class PersonalGoal9 extends PersonalGoal {
	...
	public Image getImage() {
		return Images.PERSONAL_GOAL_9.load();
	}
	...
	protected Map<MatrixCoords, BookshelfObject> initGoalObjects() {
		...
		map.put(new MatrixCoords(5, 2), BookshelfObject.GAME);
		map.put(new MatrixCoords(3, 2), BookshelfObject.CAT);
		...
		map.put(new MatrixCoords(0, 0), BookshelfObject.FRAME);
		return map;
	}
