...
public class CommonGoal_Stairs extends CommonGoal {
	...
	/**
	 * This method verifies that the player has created an ascending or descending
	 * stair form with his tiles. Check that the first row is empty, if this happens
	 * the tiles are counted using a counter, if the counter is equal to 15 it means
	 * that the player has formed a stair form with his tiles.
	 *
