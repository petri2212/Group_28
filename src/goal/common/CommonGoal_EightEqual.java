...
public class CommonGoal_EightEqual extends CommonGoal {
	...
	/**
	 * This method checks that a library has at least 8 tiles of the same type, it
	 * works by checking each cell of the library, each time a tile is found it
	 * increases a counter
	 *
	...
	public int check(Bookshelf bookshelf) {
		...
		if (contCats >= 8 || contBooks >= 8 || contGames >= 8 || contFrames >= 8 || contTrophy >= 8
				|| contPlants >= 8) {
			return 1;
		}
		return 0;
