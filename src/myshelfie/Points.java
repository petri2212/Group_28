...
/**
 * This class is used to create the common goal points stacks to handle the
 * variation of the points based on players size
 *
 */
public class Points {
	...
	/**
	 * this class will simulate the pile of cards with the common goal scores
	 * 
	...
	/**
	 * this class assigns a certain score from one of the two stacks, this score
	 * will be added to the player based on the placement array provided by the
	 * CommonGoalManager
	 * 
	 * @param common_num it is the parameter that choose from which stack the score
	 *                   will be attributed to the player
